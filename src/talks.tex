...
\begin{pubSubsectionNum}{}
  \item Keynote speech, Workshop on From Perception to Action: Representation-Centric Robot Autonomy, RSS, Sydney, Jul, 2026.

  \koronly{\item 초청강연, 제어로봇시스템학회, Jul., 2026.}

  \item Keynote speech, ICRA, Vienna, Jun, 2026.
  
  \item Keynote speech, Workshop on Long-term Deployments in the Wild, ICRA, Vienna, Jun, 2026.
   
  \item Keynote speech, Workshop on Open Challenges in Robotics for Asset Inspection and Management, ICRA, Vienna, Jun, 2026.
